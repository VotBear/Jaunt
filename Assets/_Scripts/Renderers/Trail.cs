...
public class Trail : MonoBehaviour 
{
	...
	Renderer trailObjRenderer = null;
	Mesh mesh = null;
	...
	void Start ()
	{
		...
		trailObjRenderer = trailObj.GetComponent<Renderer> ();
		trailObjRenderer.material = instanceMaterial;
	}
	...
	void Update ()
	{
		...
		if(pointCnt < 2)
		{
			trailObjRenderer.enabled = false; 
			return;
		}
		trailObjRenderer.enabled = true;
